...
(function(){
    ...
    function k(a,b){
        var c=[],d;
        for(d in a)a.hasOwnProperty(d)&&(c[d]=b(a[d]));return c
    }
    function l(a,b,c){
    ...
    var e=h(window.flashembed,{
        ...
        asString:function(a){
            ...
            switch(b){
                ...
                case "object":
                    var b=[],c;
                    for(c in a)a.hasOwnProperty(c)&&b.push('"'+c+'":'+e.asString(a[c]));return"{"+b.join(",")+"}"
            }
            return(""+
        ...
        getHTML:function(a,b){
            ...
            null;
            for(var d in a)a[d]&&(c+='<param name="'+d+'" value="'+a[d]+'" />');d="";
            if(b){
