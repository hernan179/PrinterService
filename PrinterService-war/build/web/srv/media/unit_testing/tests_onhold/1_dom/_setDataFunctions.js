...
$(document).ready( function () {
    ...
    oTest.fnTest(
        ...
        function () {
            return o.test.inner && o.test.test2===false;
        }
        );
    ...
    oTest.fnTest(
        ...
        function () {
            return o.nested.test && o.nested.test2===false;
        }
        );
    ...
    oTest.fnTest(
        ...
        function () {
            return o.test.a && o.test.b===false
        }
        );
    ...
    oTest.fnTest(
        ...
        function () {
            return o.nested.test.a && o.nested.test.b===false
        }
        );
    ...
    oTest.fnTest(
        ...
        function () {
            return o.nested.test[0]===1 && o.nested.test[2]===3
        }
        );
    ...
    oTest.fnTest(
        ...
        function () {
            return o.test.length===3 && o.test[0].a===1 && o.test[1].a===2;
        }
        );
    ...
    oTest.fnTest(
        ...
        function () {
            return o.test.length===3 && o.test[0].a.b===1 && o.test[1].a.b===2;
        }
        );
    ...
    oTest.fnTest(
        ...
        function () {
            return o.test.length===3 && o.test[0]===1 && o.test[1]===2;
        }
        );
